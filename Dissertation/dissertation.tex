...
%This may not intuitively seem like a large decrease, but as Figure \ref{fig:speed-compare} illustrates (plotted by the author), there is a significant increase in efficiency over the standard algorithm.
\begin{figure}[H]
\centering
